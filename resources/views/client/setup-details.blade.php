            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="appear-animation" data-appear-animation="fadeInUpShorter"
                    ...
                    <h3 class="font-weight-semibold text-color-dark text-transform-none text-5-5 mb-3">More
                        About Us</h3>
                    <p class="pb-1 mb-2">At FastTrack, we're dedicated to excellence. Our seasoned team brings expertise and innovation to every project, ensuring exceptional results. For personalized business consultancy</p>
                    <span
