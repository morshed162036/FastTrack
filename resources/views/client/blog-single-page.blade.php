...
<section class="page-header">
    <div class="page-header__bg" style="background-image: url({{ asset('business/img/about/blog.jfif') }});">
    </div>
    <div class="container">
                    ...
                    <div class="card-body z-index-1 p-0">
                        ...
                        <div class="post-image pb-4">
                            <img class="card-img-top custom-border-radius-1"
                                src="{{ asset('images/blog/'.$blog->image) }}" alt="Card Image">
                        </div>
                ...
                <div class="px-3">
                    ...
                    <ul class="nav nav-list flex-column mt-2 mb-0 p-relative right-9">
                        ...
                        <li class="nav-item"><a class="nav-link bg-transparent border-0"
                                href="{{ route('blog-page.edit',$category->id) }}">{{ $category->title }}</a>
                        </li>
                        @endforeach
                        @endif
                    </ul>
