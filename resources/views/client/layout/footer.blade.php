<footer id="footer" class="border-top-0 m-0 lazyload"
    ...
    <div class="container pt-3">
        <div class="row justify-content-between align-items-center py-2 mb-2">
                ...
                <div class="col-lg-3 mb-4 col-md-6  mb-lg-0">
                    ...
                    <a href="{{ route('client.home') }}" class="text-decoration-none">
                        <img src="@if ($company->logo)
                            ...
                            @endif" class="img-fluid mb-4" width="123" height="33" alt="" />
                    </a>
                    <p class="text-3-5">FastTrack: Navigating Business Excellence, Where Expertise Meets Innovation."
                    </p>
                    <ul
                        ...
                        <li class="social-icons-facebook"><a href="@if ($company->facebook)
                            ...
                            @endif" target="_blank" title="Facebook" data-cursor-effect-hover="fit"><i
                                    class="fab fa-facebook-f"></i></a>
                        </li>
                        <li class="social-icons-twitter mx-2"><a href="@if ($company->twitter)
                                http://{{ $company->twitter }}
                            @endif" target="_blank" title="Twitter" data-cursor-effect-hover="fit"><i
                                    class="fab fa-twitter"></i></a>
                        </li>
                        <li class="social-icons-instagram">
                            <a href="@if ($company->instagram)
                                    http://{{ $company->instagram }}
                                @endif" target="_blank" class="text-4" title="Instagram"
                ...
                <div class="col-lg-3 mb-4 mb-lg-0 col-md-6 col-sm-6">
                    ...
                    <ul class="list list-icons list-icons-lg">
                        <li class="d-flex px-0 mb-1">
                            <img width="25" src="{{ asset('business/img/demos/business-consulting-3/icons/phone.svg')}}"
                        ...
                        <li class="d-flex px-0 my-3">
                            <img width="25" src="{{ asset('business/img/demos/business-consulting-3/icons/email.svg')}}"
                        ...
                        <li class="d-flex font-weight-semibold text-color-light px-0 mb-1">
                            <img width="25"
                                src="{{ asset('business/img/demos/business-consulting-3/icons/map-pin.svg')}}"
