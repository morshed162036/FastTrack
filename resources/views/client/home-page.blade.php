...
<div id="home"
                            ...
                            <div class="d-flex flex-column align-items-center">
                                <h3 class="position-relative text-color-light text-4 line-height-5 font-weight-medium px-4 mb-3 appear-animation"
                                    ...
                                    <span class="position-absolute right-100pct top-50pct transform3dy-n50 opacity-3">
                                        <img src="img/slides/slide-title-border.png" class="w-100"
    ...
    <div class="owl-dots mb-5">
        ...
        @for ($i=1;$i<$banner_count; $i++) <button role="button" class="owl-dot"><span></span></button>
            @endfor
        ...
        <div class="col-md-10 col-lg-6 mb-5 mb-lg-0 ">
            <div class="row row-gutter-sm ">
                <div class="col-6  " id="about">
                    <img id="about_img" src="{{ asset('business/img/short-about.jpg') }}" class="box-shadow-5 img-fluid
" alt="" />
</div>
</div>
</div>
...
<div class="container pt-5">
    <div class="row py-2 mb-2">
        <div class="col-md-6 order-md-2 mb-4 mb-lg-0 appear-animation" data-appear-animation="fadeInLeftShorter" id="about">
            <img src="{{ asset('business/img/about_us.jfif') }}" class="img-fluid w-100 mb-2" alt="">
        </div>
        <div class="col-md-6 order-4">
            <div class="overflow-hidden home_about mt-lg-5">
                <h2 class=" custom-highlight-text-1 d-inline-block line-height-5 text-4 positive-ls-3 font-weight-medium  mb-2 appear-animation"
                    data-appear-animation="fadeInUpShorter" id="choose-text">ABOUT US</h2>
                <h3 class="text-9 text-lg-5 text-xl-9 line-height-3 text-transform-none font-weight-semibold mb-4 mb-lg-3 mb-xl-4 appear-animation"
                    data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">@if ($about_us)
                    {{ $about_us->title }}
                    @endif</h3>
                <p class="text-3-5 pb-1 mb-4 mb-lg-2 mb-xl-4 appear-animation text-justify"
                ...
                <div class="appear-animation" data-appear-animation="fadeInUpShorter"
                    ...
                    <a href="{{ route('client.about-page') }}"
                        class="btn btn-primary custom-btn-style-1 font-weight-semibold btn-px-4 btn-py-2 text-3-5 px-3"
                        data-cursor-effect-hover="plus" data-cursor-effect-hover-color="light"><span>Read
                            More</span></a>
                    <a href="{{ route('client.contact-page') }}"
                        class="btn btn-primary custom-btn-style-1 font-weight-semibold btn-px-4 mx-2 btn-py-2 text-3-5 px-3"
                        data-cursor-effect-hover="plus" data-cursor-effect-hover-color="light"><span>Get a
                            Quote</span></a>
                </div>
            </div>
    ...
    @if ($services)
    <section class="section-height-4 section-with-shape-divider  border-0 pb-5 m-0">
        <div class="container mt-4">
            <div class="row justify-content-center">
                <div class="col-lg-11 col-xl-10 text-center">
                    ...
                    actionable solutions to help your business excel. Discover how we can elevate your business success.</p>
                </div>
            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="pricing-one__price-box">
                                            <p class="pricing-one__price-title text-center">{{ $pricingplan->title }}
                                            </p>
