...
@section('content')
    ...
    <section class="page-header">
        <div class="page-header__bg" style="background-image: url({{ asset('business/img/about/about-common.jfif') }});">
        </div>
        <div class="container">
    ...
    <div id="aboutus" class="row align-items-xl-center pt-4 mt-5 px-3">
       <div class="row py-2 mb-2">
        ...
        <div class="col-lg-6">
            ...
            <div class="text-3-5 pb-1 mb-4 mb-lg-2 mb-xl-4 appear-animation text-justify"
            ...
            <div class="appear-animation text-center" data-appear-animation="fadeInUpShorter"
        ...
        <div class="container">
            <div class="row align-items-center py-2 my-5 mb-lg-0 my-xl-5">
                <div class="col-lg-7 mb-2 mb-lg-0 md_speach_first_part">
                    ...
                    <div class="text-3-5 pb-1 mb-4 mb-lg-2 mb-xl-4 appear-animation line-height-6 text-justify"
                        data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">
                        {!! $ceo_message->pera_1 !!}
                    </div>
                </div>
                ...
                @if ($ceo_message->pera_2)
                    <div class="md_speach_2nd text-justify">
