            ...
            <div class="col-12 col-lg-8">
                <div class="left_side">
                    ...
                    <img src="@if ($details->image)
                        {{ asset('images/service/'.$details->image) }}
                    @endif" class="img-fluid w-100">

                    <h2 class="services_headig mt-3">{{ $details->service->title }}</h2>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="appear-animation" data-appear-animation="fadeInUpShorter"
                    ...
                    <h3 class="font-weight-semibold text-color-dark text-transform-none text-5-5 mb-3">More
                        About Us</h3>
                    <p class="pb-1 mb-2">At FastTrack, we are dedicated to excellence. Our seasoned team brings expertise and innovation to every project, ensuring exceptional results. For personalized business consultancy</p>
                    <span
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="appointment-one__right">
                            <div class="appointment-one__form-box">
                                <form action="{{ route('service-page.store') }}" method="post"
                                            ...
                                            <div class="appointment-one__input-box">
                                                ...
                                                <div class="appointment-one__showing-sort">
                                                    <select class="selectpicker"
                                                        aria-label="Default select example" required name="service_id">
